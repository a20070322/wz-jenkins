...
const Log = {
    ...
    info(...args) {
        ...
        log.call(console, chalk__default["default"].cyan("Info:"), chalk__default["default"].cyan(...args));
    },
    /** warn */
    warn(...args) {
        const log = console.log;
        log.call(console, chalk__default["default"].yellow("Warn:"), chalk__default["default"].yellow(...args));
    },
    /** error */
    error(...args) {
        const log = console.log;
        log.call(console, chalk__default["default"].red("Error:"), chalk__default["default"].red(...args));
